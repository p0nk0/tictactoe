...
(** This file contains exercises 1-4. For instructions refer to the README at the
...
val losing_moves : me:Piece.t -> game_kind:Game_kind.t -> pieces:Piece.t Position.Map.t -> Position.t list
